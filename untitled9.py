...
Question1=Label(root,text="Do you have headche and sore throat??")
Question1.pack()
...
def fever_score():
    ...
    if score<=20:
        messagebox.showinfo("Report","You don't need to go to Dr.")
    elif score > 20 and score<= 40:
        messagebox.showinfo("Report","You might perhaps have to visit a Dr.")
    else:
        messagebox.showinfo("Report","I strongly advise you to visit a Dr.")
